    ...
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            if (u != null)
            {
                ...
                if (db_Accounts.UpdateT_OE_USERS(u.USER_IDX, hashpass, salt, null, null, null, null, false, null, null, null, null, 0, null, null, null, null) == 1)
                    return true;
                else
                    return false;
            }
        ...
        public override string ResetPassword(string username, string answer)
        {
            ...
            if (u != null)
            {
                ...
                if (db_Accounts.UpdateT_OE_USERS(u.USER_IDX, hashpass, salt, null, null, null, null, true, null, null, null, null, null, 0, null, null, null) == 1)
                {
                    //encrypt username for email
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            if (u != null)
            {
                ...
                {
                    db_Accounts.UpdateT_OE_USERS(u.USER_IDX, null, null, null, null, null, u.LOG_ATMPT.ConvertOrDefault<int>() < MaxInvalidPasswordAttempts, null, null, null, null, null, null, u.LOG_ATMPT.ConvertOrDefault<int>() + 1, null, null, null);
