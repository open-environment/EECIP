...
GO
 ...
 CREATE TABLE [dbo].[T_OE_REF_ENTERPRISE_PLATFORM](
	...
	[ENT_PLATFORM_DESC] [varchar](500) NULL,
...
CREATE TABLE [dbo].[T_OE_ORGANIZATION_TAGS](
	...
	[ORG_TAG_IDX] [int] NOT NULL,
	[CREATE_USERIDX] [int] NULL,
	[CREATE_DT] [datetime2](0) NULL,
 CONSTRAINT [PK_T_OE_ORGANIZATION_TAGS] PRIMARY KEY CLUSTERED ([ORG_IDX], [ORG_ATTRIBUTE], [ORG_TAG_IDX] ASC),
 FOREIGN KEY ([ORG_IDX]) references [T_OE_ORGANIZATION] ([ORG_IDX]) ON UPDATE CASCADE 	ON DELETE CASCADE,
 FOREIGN KEY ([ORG_TAG_IDX]) references [T_OE_REF_TAGS] ([TAG_IDX]) ON UPDATE CASCADE ON DELETE CASCADE 
) ON [PRIMARY]
...
CREATE TABLE [dbo].[T_OE_USER_EXPERTISE](
	[USER_IDX] [int] NOT NULL,
	[EXPERTISE_TAG_IDX] [int] NOT NULL,
	[CREATE_USERIDX] [int] NULL,
	[CREATE_DT] [datetime2](0) NULL,
 CONSTRAINT [PK_T_OE_USER_EXPERTISE] PRIMARY KEY CLUSTERED ([USER_IDX], [EXPERTISE_TAG_IDX] ASC),
 FOREIGN KEY (USER_IDX) references T_OE_USERS (USER_IDX) ON UPDATE CASCADE 	ON DELETE CASCADE,
 FOREIGN KEY ([EXPERTISE_TAG_IDX]) references [T_OE_REF_TAGS] ([TAG_IDX]) ON UPDATE CASCADE ON DELETE CASCADE 
) ON [PRIMARY]
