...
CREATE TABLE [dbo].[T_OE_PROJECTS](
	...
	[MODIFY_USERIDX] [int] NULL,
	[MODIFY_DT] [datetime2](0) NULL,
	LAST_NOTIFY_DT datetime2(0) NULL,
...
--  alter table T_OE_PROJECTS ADD LAST_NOTIFY_DT datetime2(0) NULL;
...
GO
 ...
 COALESCE(P.MODIFY_DT, P.CREATE_DT) as CREAT_UPDATE_DT, P.LAST_NOTIFY_DT, 
 CASE WHEN COALESCE(P.MODIFY_DT, P.CREATE_DT) > coalesce(P.LAST_NOTIFY_DT,'1/1/1990') 
	  THEN COALESCE(P.MODIFY_DT, P.CREATE_DT) else P.LAST_NOTIFY_DT end as TRU_LAST_DT,
 CASE WHEN COALESCE(P.MODIFY_DT, P.CREATE_DT) > coalesce(P.LAST_NOTIFY_DT,'1/1/1990') 
	  THEN DATEADD(month, 6, COALESCE(P.MODIFY_DT, P.CREATE_DT)) else DATEADD(month,6,P.LAST_NOTIFY_DT) end as TRU_NEXT_DT
 from T_OE_PROJECTS P, T_OE_USERS U
 where P.PROJECT_CONTACT_IDX=U.USER_IDX
 and U.ACT_IND=1 
 and P.PROJ_STATUS in ('Active','In development')
 and  CASE WHEN COALESCE(P.MODIFY_DT, P.CREATE_DT) > coalesce(P.LAST_NOTIFY_DT,'1/1/1990') 
	  THEN DATEADD(month, 6, COALESCE(P.MODIFY_DT, P.CREATE_DT)) else DATEADD(month,6,P.LAST_NOTIFY_DT) end < GETDATE()
GO